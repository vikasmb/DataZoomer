...
public class QueryPredictor {
	...
	QueryPredictor(){
	      try
	      {
	         FileInputStream fis = new FileInputStream("/Users/mariyamkhalid/Documents/workspace/hashmap.ser");
	...
	public void start()
	{
		...
		int a=Arrays.asList(fields).indexOf("media_revenue_from_buyer");
